...
**Option A — Cloud Build + Dockerfile (recommended; avoids Buildpack failures)**

From repo root (e.g. `IkaLanguage/`):
...
**Option B — Deploy from source (PowerShell, Windows)**
...
**Option B — Deploy from source (Bash / Cloud Shell)**
